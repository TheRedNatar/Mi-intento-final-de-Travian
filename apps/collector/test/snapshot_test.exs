defmodule Collector.AggPlayersTest do
  ...
  test "Snapshot.process_rows() transform the raw_snapshot rows to a list of Snapshot structs and creates the *_id fields" do
    server_id = "server_x"
    raw_snapshot = "INSERT INTO `x_world` VALUES (27,-174,200,3,39983,'New village',13,'Masbro',251,'ÖFKE',41,NULL,FALSE,NULL,NULL);
...
INSERT INTO `x_world` VALUES (115,-86,200,1,39368,'02',9808,'Aeirdun',235,'AP',104,NULL,FALSE,NULL,NULL);"
  ...
  test "Snapshot.process_rows() catch error rows" do
    server_id = "server_x"
    raw_snapshot = "INSERT INTO `x_world` VALUES (27,-174,200,3,39983,'New village',13,'Masbro',251,'ÖFKE');
INSERT INTO `x_world` VALUES (115,-86,200,1,39368,'02',9808,'Aeirdun',235,'AP',104,NULL,FALSE,NULL,NULL);"
...
INSERT INTO `x_world` VALUES (115,-86,200,1,39368,'02',9808,'Aeirdun',235,'AP',104,NULL,FALSE,NULL,NULL);"
    ...
    assert(:ok == Collector.RawSnapshot.store(root_folder, server_id, raw_snapshot, target_date))
    assert(:ok == Collector.Snapshot.run(root_folder, server_id, target_date))
    {:ok, snapshot} = Collector.Snapshot.open(root_folder, server_id, target_date)
