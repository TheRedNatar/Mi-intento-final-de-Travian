defmodule Collector.AggPlayers.Increment do
  ...
  @spec increment(target_dt :: DateTime.t(), player_id :: TTypes.player_id(), new_player_snapshot :: [TTypes.enriched_row()], prev_player_snapshot :: [TTypes.enriched_row()]) :: t()
  ...
  @spec increment(target_dt :: DateTime.t(), new_player_snapshot :: [TTypes.enriched_row()]) :: t()
