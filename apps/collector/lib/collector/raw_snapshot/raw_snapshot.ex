defmodule Collector.RawSnapshot do
  defp raw_snapshot_options(), do: {"raw_snapshot", ".c6bert"}
  ...
  def open(root_folder, server_id, target_date) do
    case Storage.open(root_folder, server_id, raw_snapshot_options(), target_date) do
  ...
  def store(root_folder, server_id, raw_snapshot, target_date) do
    ...
    Storage.store(root_folder, server_id, raw_snapshot_options(), encoded, target_date)
  end
