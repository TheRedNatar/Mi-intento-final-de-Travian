defmodule Collector do
  ...
  @spec open(root_folder :: String.t(), server_id :: TTypes.server_id(), target_date :: Date.t()) :: {:ok, [TTypes.enriched_row()]} | {:error, any()}
  ...
  @spec store(root_folder :: String.t(), server_id :: TTypes.server_id(), snapshot :: [TTypes.enriched_row()], target_date :: Date.t()) :: :ok | {:error, any()}
