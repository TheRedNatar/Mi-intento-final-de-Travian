defmodule Storage do
  ...
  @spec list_dates(root_folder :: String.t(), identifier :: dest_identifier(), flow_options :: flow_options) :: [Date.t()]
  ...
  defp filename_to_date(filename = <<"date_", s_year::binary-size(4), s_month::binary-size(2), s_day::binary-size(2), _::binary>>) do
